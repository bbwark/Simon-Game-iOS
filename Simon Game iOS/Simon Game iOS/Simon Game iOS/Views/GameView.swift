...
struct GameView: View {
    ...
    var body: some View {
        ...
        VStack{
            ...
            HStack{
                TileView(color: .red, bright: $firstBright)
                    .onTapGesture {
                        if(touchable){
                ...
                TileView(color: .blue, bright: $secondBright)
                    .onTapGesture {
                        if(touchable){
            ...
            HStack{
                TileView(color: .green, bright: $thirdBright)
                    .onTapGesture {
                        if(touchable){
                ...
                TileView(color: .yellow, bright: $fourthBright)
                    .onTapGesture {
                        if(touchable){
